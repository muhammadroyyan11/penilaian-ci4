					...
					<form id="formAuthentication" class="mb-3" action="<?= url_to('login') ?>" method="POST">
						...
						<?php else : ?>
							<div class="mb-3">
								...
								<input type="text" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" id="email"  name="login" placeholder="Enter your email or username" autofocus />
							</div>
						<?php endif; ?>
